 ...
 * @author Win
 */
@WebServlet(urlPatterns = {"/alumnomod"})
public class alumnomod extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet alumnomod</title>");            
            out.println("</head>");
