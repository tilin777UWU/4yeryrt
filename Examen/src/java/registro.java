...
@Override 
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String agregaralumno="insert into datos (nombre,calificacion)"
                    + " values ('"+nombre+"', '"+apellido+"', '"+grupo+"', '"+grado+"', '"+clave_examen+"')";
            ...
            out.println("<td><input type='submit' value='REGRESAR AL MENU PRINCIPAL' button style=background-color:#f2ddd2;></td>");
            out.println("</body>");
            out.println("</html>");
        }
    }
