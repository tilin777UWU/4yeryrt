...
public class examenmod extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<form action='registroexamen'>");
            out.println("<center><input type='submit' value='REGISTRA' button style=background-color:#d0b7be;></center>");
            out.println("</form><hr>");
         
            out.println("<form action='consultaexamen'>");
            out.println("<center><input type='submit' value='CONSULTA' button style=background-color:#d0b7be;></center>");
            out.println("</form><hr>");
         
            out.println("<form action='MODIFICAEXAMEN'>");
            out.println("<center><input type='submit' value='MODIFICAR' button style=background-color:#d0b7be;></center>");
            out.println("</form><hr>");
            
            out.println("<form action='eliminarexamen'>");
