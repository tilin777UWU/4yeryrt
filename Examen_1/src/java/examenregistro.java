 ...
 * @author Win
 */
@WebServlet(urlPatterns = {"/examenregistro"})
public class examenregistro extends HttpServlet {
Connection conexion;
...
@Override 
    public void init()
    {
     ...
     public String insertar (String registroexamen)
      {
          String html="";
          try
          {
              Statement a=conexion.createStatement();
              int fila=a.executeUpdate(registroexamen);
              return html+=fila+"Examen Registrado(s)";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String registroexamen="insert into examenes (clave_examen,nombre,p1,p2,p3,p4,p5)"
                    + " values ('"+clave_examen+"','"+nombre+"', '"+p1+"', '"+p2+"', '"+p3+"', '"+p4+"','"+p5+"')";
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h2>"+insertar(registroexamen)+"</h2><br>");
