...
Connection conexion;
    ...
    public void init()
    {
     try 
     {
      ...
      public String borrar (String eliminaralumno)
      {
          String html="";
          try
          {
              Statement a=conexion.createStatement();
              int fila=a.executeUpdate(eliminaralumno);
              return html+=fila+"Alumno(s) Eliminado(s)";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String eliminaralumno= "delete from datos where clave= " + clave;
           ...
           out.println("<h1><form method='post' action='Profesor'></h1>");
            ...
            out.println("<H2>" + borrar(eliminaralumno) + "</h2><br>");
            out.println("</body>");
            out.println("</html>");
        }
    }
